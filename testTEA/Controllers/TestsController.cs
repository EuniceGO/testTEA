...
namespace testTEA.Controllers
{
    public class TestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_test,nombre,descripcion")] test test)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_test,nombre,descripcion")] test test)
        {
            if (id != test.id_test)
            {
                return NotFound();
